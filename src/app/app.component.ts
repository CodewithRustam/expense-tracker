...
export class AppComponent {
  ...
  public async initPush() {
    ...
    // Only proceed if it's been more than 2 hours
    if (now - lastTime < twoHours) {
      console.log('Skipping push registration: Already registered within the last 24h');
      return;
    }
    ...
    try {
      ...
      // 2. Clear listeners to avoid duplicates
      await PushNotifications.removeAllListeners();

      // 3. Listen for Registration (The Device Token)
      PushNotifications.addListener('registration', (token) => {
        // Use your notificationService here!
      ...
      // 5. Listen for user clicking the notification
      ...
      // 6. Finally, Register with Apple/Google
